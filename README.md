...
8. Optimize the [SYSCTL](https://github.com/AmirReza2012/Linux-Optimizer/blob/main/files/sysctl.conf) Configs:
...
9. Optimize [SSH](https://github.com/AmirReza2012/Linux-Optimizer/blob/main/files/sshd_config):
...
10. Optimize the [System Limits](https://github.com/AmirReza2012/Linux-Optimizer/blob/main/files/profile):
...
#### Then:
```
wget "https://raw.githubusercontent.com/AmirReza2012/Linux-Optimizer/main/linux-optimizer.sh" -O linux-optimizer.sh && chmod +x linux-optimizer.sh && bash linux-optimizer.sh 
```


## Menu Image
### Debian & Ubuntu:
![debian-based-menu](https://github.com/AmirReza2012/Linux-Optimizer/assets/16742123/3604470e-48ed-403d-a753-143dc934f6fd)

### CentOS, AlmaLinux & Fedora:
![rhel-based-menu](https://github.com/AmirReza2012/Linux-Optimizer/assets/16742123/07099e64-3864-425f-83e2-cda1e57d5b62)
